...
class ProfileController extends Controller
{
     ...
     */
    public function show(): View // Menggunakan 'show' sesuai konvensi
    {
        $user = Auth::user();
        // Pastikan view path ini sesuai dengan lokasi file Blade Anda
        // Berdasarkan struktur folder Anda: resources/views/profile/profile.blade.php
