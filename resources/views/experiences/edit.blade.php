...
<head>
 ...
 <title>Edit Pengalaman - SkillHub</title>
 ...
 <style>
    ...
    /* Page-specific Header for Edit Experience */
    .page-header {
        max-width: 900px;
    ...
    .checkbox-group input {
        width: auto; /* Untuk checkbox agar tidak 100% lebar */
    }
...
<div class="form-container">
    {{-- Form untuk mengupdate pengalaman. Mengarah ke ExperienceController@update --}}
    <form action="{{ route('experiences.update', $experience->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="date" id="start_date" name="start_date" value="{{ old('start_date', $experience->start_date ? \Carbon\Carbon::parse($experience->start_date)->format('Y-m-d') : '') }}" required>
            @error('start_date')
                <span style="color:red; font-size:0.85rem;">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            {{-- Format tanggal untuk input type="date" harus YYYY-MM-DD --}}
            <input type="date" id="end_date" name="end_date" value="{{ old('end_date', $experience->end_date ? \Carbon\Carbon::parse($experience->end_date)->format('Y-m-d') : '') }}">
            @error('end_date')
                <span style="color:red; font-size:0.85rem;">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn">Perbarui Pengalaman</button>
        </div>
    </form>
</div>
