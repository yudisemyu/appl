...
<head>
 ...
 <title>Tambah Sertifikat Baru - SkillHub</title>
 ...
 <style>
    ...
    /* Page-specific Header for Create Certificate */
    .page-header {
        max-width: 900px;
    ...
    /* Form Container */
    .form-container {
        max-width: 700px; /* Lebih kecil untuk fokus pada form */
    ...
    .form-group input[type="file"] {
        padding: 10px 12px; /* Sedikit lebih kecil karena sudah ada tombol browse bawaan */
        cursor: pointer;
    }
...
<div class="form-container">
    {{-- Form untuk menyimpan sertifikat baru. Mengarah ke SertifikatController@store --}}
    <form action="{{ route('sertifikat.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="file" id="file_path" name="file_path" accept=".pdf,image/*" required>
            @error('file_path')
                <span style="color:red; font-size:0.85rem;">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn">Simpan Sertifikat</button>
        </div>
    </form>
</div>
